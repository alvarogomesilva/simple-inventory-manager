            ...
            <div className="flex-1 overflow-auto">
                <header className="bg-white shadow-sm">
                    <div className="flex items-center justify-between px-4 py-4 lg:px-8">
                        <button className="rounded-md p-2 text-gray-500 cursor-pointer hover:bg-gray-100 lg:hidden" onClick={toggleSidebar}>
                            <MenuIcon size={25} />
                        </button>
                            ...
                            <div className="relative" ref={userMenuRef}>
                                ...
                                {userMenuOpen && (
                                    <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                        ...
                                        <a onClick={() => logout()} className="cursor-pointer flex items-center px-4 py-2 text-sm text-red-600 hover:bg-gray-100">
